...
import { User, Shield, Bell, Briefcase, ChevronRight, Edit, LogOut, Check, X, Mail } from 'lucide-react';
...
const mockServices = [
  { id: '1', name: 'Giúp Việc Gia Đình', description: 'Dọn dẹp nhà cửa theo giờ', price: '250.000 VNĐ' },
  { id: '2', name: 'Vệ Sinh Sofa & Nệm', description: 'Làm sạch sâu sofa, nệm và rèm', price: '450.000 VNĐ' },
  { id: '3', name: 'Dọn Dẹp Văn Phòng', description: 'Dịch vụ dọn dẹp cho công ty', price: 'Liên hệ' },
];
const SettingsPage = () => {
  ...
  return (
    ...
    <main className="bg-gray-100 min-h-screen pt-20 pb-12">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-6 sm:p-10">
        <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center sm:text-left">Cài Đặt</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8 transition-all duration-300 hover:shadow-md">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-xl font-semibold text-gray-700">Hồ Sơ Cá Nhân</h2>
            </div>
            {isEditingProfile ? (
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-8">
            ...
            <div className="text-center sm:text-left flex-1">
              <div className="flex flex-col mb-2">
                <label className="text-sm font-medium text-gray-500 mb-1">Tên của bạn</label>
                {isEditingProfile ? (
                  <input
                    type="text"
                    value={user.name}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8 transition-all duration-300 hover:shadow-md">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h2 className="text-xl font-semibold text-gray-700">Quản Lý Dịch Vụ</h2>
          </div>
          <p className="text-gray-600 mb-4">Danh sách các dịch vụ bạn đang cung cấp:</p>
          <ul className="space-y-4">
            {mockServices.map(service => (
              <li key={service.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-xl transition-all duration-300 hover:bg-gray-100">
                <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button className="p-2 text-emerald-600 hover:bg-emerald-100 rounded-full transition-colors" aria-label={`Mở ${service.name}`}>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 transition-all duration-300 hover:shadow-md">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-700">Bảo Mật</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 transition-all duration-300 hover:shadow-md">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-700">Thông Báo</h2>
            </div>
        ...
        <div className="text-center mt-8">
          <button className="flex items-center justify-center mx-auto text-red-500 hover:text-red-700 font-medium py-3 px-6 rounded-full transition-colors">
