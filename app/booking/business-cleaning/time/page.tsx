// app/booking/business-cleaning/time/page.tsx
'use client';
...
const TimeStep = () => {
    ...
    useEffect(() => {
        localStorage.setItem('businessBookingData', JSON.stringify(bookingData));
    }, [bookingData]);
    ...
    const handleNext = () => {
        ...
        setValidationError('');
        router.push('/booking/business-cleaning/confirm');
    };
    return (
        <BookingLayout
            title="Vệ sinh Công nghiệp - Bước 2: Lịch & Gói"
            onBack={() => router.push('/booking/business-cleaning/service')}
            footer={
                <button
                    onClick={handleNext}
